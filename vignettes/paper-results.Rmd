...
```{r}
unit.weights = synthdid_controls(estimates[1:3], weight.type='omega', mass=1, sort.by=3)
time.weights = synthdid_controls(estimates[1:3], weight.type='lambda', mass=1, sort.by=3)

round(unit.weights, digits=3)
round(time.weights, digits=3)
```
