...
print(xtable(display.point.table[1:14,]), type='latex', file='figures/cps-table.tex')
print(xtable(display.point.table[17:19,]), type='latex', file='figures/penn-table.tex')
print(xtable(reg.comparison.table), type='latex', file='figures/reg-comparison-table.tex')
```
